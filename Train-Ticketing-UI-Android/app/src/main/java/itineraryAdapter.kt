...
import com.example.trainticket.R
import models.itinerary

class itineraryAdapter(private val context: Activity, private val arrayList: ArrayList<itinerary>): ArrayAdapter<itinerary>(context, R.layout.itinerary_row, arrayList) {
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        travelClassInfo.text = arrayList[position].travelClassInfo
